...
class RelativeRadioGroup(context: Context?, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) :
    ...
    override fun onInitializeAccessibilityEvent(event: AccessibilityEvent) {
        ...
        event.className = RelativeRadioGroup::class.java.name
    }

    override fun onInitializeAccessibilityNodeInfo(info: AccessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(info)
        info.className = RelativeRadioGroup::class.java.name
    }
    ...
    interface OnCheckedChangeListener {
         ...
         */
        fun onCheckedChanged(group: RelativeRadioGroup?, checkedId: Int)
    }
    ...
    private inner class PassThroughHierarchyChangeListener : OnHierarchyChangeListener {
        ...
        override fun onChildViewAdded(parent: View, child: View) {
            if (parent === this@RelativeRadioGroup) {
